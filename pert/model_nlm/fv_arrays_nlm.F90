...
!nested grid flags:
  ...
  type inline_mp_type
    real, allocatable :: prer(:,:)     
    real, allocatable :: prei(:,:)     
    real, allocatable :: pres(:,:)     
    real, allocatable :: preg(:,:)     

    real, allocatable :: qv_dt(:,:,:)
    real, allocatable :: ql_dt(:,:,:)
    real, allocatable :: qi_dt(:,:,:)
    ...
    real, allocatable :: u_dt(:,:,:)
    real, allocatable :: v_dt(:,:,:)
  end type inline_mp_type

  type phys_diag_type

     real, allocatable :: phys_t_dt(:,:,:)
     real, allocatable :: phys_qv_dt(:,:,:)
     real, allocatable :: phys_ql_dt(:,:,:)
     real, allocatable :: phys_qi_dt(:,:,:)
     real, allocatable :: phys_liq_wat_dt(:,:,:)
     real, allocatable :: phys_ice_wat_dt(:,:,:)
     real, allocatable :: phys_qr_dt(:,:,:)
     real, allocatable :: phys_qg_dt(:,:,:)
     real, allocatable :: phys_qs_dt(:,:,:)
     real, allocatable :: phys_u_dt(:,:,:)
     real, allocatable :: phys_v_dt(:,:,:)
  ...
  type coarse_restart_type
     ...
     real, allocatable :: pt(:,:,:)
     real, allocatable :: q(:,:,:,:)
     real, allocatable :: qdiag(:,:,:,:)
     real, allocatable :: delz(:,:,:)
     real, allocatable :: phis(:,:)
     real, allocatable :: delp(:,:,:)
     real, allocatable :: ua(:,:,:)
     real, allocatable :: va(:,:,:)
     real, allocatable :: u_srf(:,:)
     real, allocatable :: v_srf(:,:)
     real, allocatable :: sgh(:,:)
     real, allocatable :: oro(:,:)
     real, allocatable :: ze0(:,:,:)
...
! For downscaling/remapping a 2d variable from parent to its nest
    real, allocatable :: parent2nest_2d(:,:)  !< 2d arrary for downscaling a variable from parent to its nest
...
! For stochastic kinetic energy backscatter (SKEB)
    real, allocatable :: diss_est(:,:,:)  !< dissipation estimate taken from 'heat_source'
